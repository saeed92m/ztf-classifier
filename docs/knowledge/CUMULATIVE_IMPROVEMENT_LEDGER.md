...
| Current hardening cycle | PR #72 lifecycle contract | Enforce machine-readable cycle records in CI | Lifecycle records advisory | Every meaningful PR must carry a validated cycle record | Enforcement/reproducibility improved | None known | N/A | AD-CI-007 | New CI enforcement tests | Pending | Use cycle records as inputs to release and process analytics |
